...
export function formatCompactRate(bytesPerSec: number | null | undefined): string {
...
export function buildLinePath(pts: number[], max: number): string {
...
export function buildAreaPath(linePath: string): string {
  if (!linePath) return '';
